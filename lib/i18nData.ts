...
// Importing exports from a "use client" file into a Server Component turns
// them into opaque client references, so the raw translation data and the
// JSON-LD builder must live here, separate from the LanguageProvider/hook.
    ...
    plans: [
      {
        ...
        features: ["One professional page", "Contact form or call button", "Mobile-friendly design", "Basic SEO setup", "Social media links", "1 month of free updates included"],
        cta: "Get Started",
      ...
      },
      {
        ...
        features: ["Multi-page professional design", "Services & about sections", "Contact form & call button", "Google Maps integration", "Mobile-friendly & fast", "1 month of free updates included"],
        cta: "Get Started",
        legalNote: "Launch pricing is available for a limited time. Start now and lock in your introductory rate before prices increase.",
      },
      {
        ...
        features: ["Product pages & catalog", "Shopping cart & checkout", "Secure payment connection", "Mobile-friendly design", "Basic store organization", "1 month of free updates included"],
        cta: "Get Started",
        legalNote: "Launch pricing is available for a limited time. Start now and lock in your introductory rate before prices increase.",
      },
      {
        ...
        features: ["Contact form", "Call & email buttons", "Location & map", "Booking button or calendar link", "Mobile-friendly design", "1 month of free updates included"],
        cta: "Get Started",
        legalNote: "Launch pricing is available for a limited time. Start now and lock in your introductory rate before prices increase.",
      },
      {
        ...
        features: ["Text & image updates", "Layout improvements", "Mobile fixes", "Section cleanup", "Visual refresh", "1 month of free updates included"],
        cta: "Get Started",
        legalNote: "Launch pricing is available for a limited time. Start now and lock in your introductory rate before prices increase.",
      },
      {
        ...
        features: ["Domain connection", "Hosting setup (Bluehost)", "SSL security certificate", "Monthly uptime monitoring", "Technical support", "1 month of free updates included"],
        cta: "Get Started",
        legalNote: "Launch pricing is available for a limited time. Start now and lock in your introductory rate before prices increase.",
      },
      {
        ...
        features: ["Mobile apps (iOS & Android)", "Advanced web applications", "Custom integrations", "Tailored scope & timeline", "Direct consultation", "1 month of free updates included"],
        cta: "Talk to us",
      },
    ],
  },
    ...
    plans: [
      {
        ...
        features: ["Una página profesional", "Formulario de contacto o botón de llamada", "Diseño compatible con móvil", "Configuración básica de SEO", "Links a redes sociales", "1 mes de actualizaciones gratis incluido"],
        cta: "Comenzar",
      ...
      },
      {
        ...
        features: ["Diseño multipágina profesional", "Secciones de servicios y acerca de", "Formulario de contacto y llamada", "Integración con Google Maps", "Diseño compatible con móvil", "1 mes de actualizaciones gratis incluido"],
        cta: "Comenzar",
        legalNote: "Precio de lanzamiento disponible por tiempo limitado. Comienza ahora y asegura tu tarifa introductoria antes de que suban los precios.",
      },
      {
        ...
        features: ["Páginas de producto y catálogo", "Carrito y checkout", "Conexión de pago seguro", "Diseño compatible con móvil", "Organización básica de tienda", "1 mes de actualizaciones gratis incluido"],
        cta: "Comenzar",
        legalNote: "Precio de lanzamiento disponible por tiempo limitado. Comienza ahora y asegura tu tarifa introductoria antes de que suban los precios.",
      },
      {
        ...
        features: ["Formulario de contacto", "Botones de llamada y correo", "Ubicación y mapa", "Botón de reserva o link de calendario", "Diseño compatible con móvil", "1 mes de actualizaciones gratis incluido"],
        cta: "Comenzar",
        legalNote: "Precio de lanzamiento disponible por tiempo limitado. Comienza ahora y asegura tu tarifa introductoria antes de que suban los precios.",
      },
      {
        ...
        features: ["Actualización de texto e imágenes", "Mejoras de diseño", "Correcciones para móvil", "Limpieza de secciones", "Refresco visual", "1 mes de actualizaciones gratis incluido"],
        cta: "Comenzar",
        legalNote: "Precio de lanzamiento disponible por tiempo limitado. Comienza ahora y asegura tu tarifa introductoria antes de que suban los precios.",
      },
      {
        ...
        features: ["Conexión de dominio", "Configuración de hosting (Bluehost)", "Certificado SSL", "Monitoreo mensual", "Soporte técnico", "1 mes de actualizaciones gratis incluido"],
        cta: "Comenzar",
        legalNote: "Precio de lanzamiento disponible por tiempo limitado. Comienza ahora y asegura tu tarifa introductoria antes de que suban los precios.",
      },
      {
        ...
        features: ["Apps móviles (iOS y Android)", "Aplicaciones web avanzadas", "Integraciones personalizadas", "Alcance y cronograma a medida", "Consulta directa", "1 mes de actualizaciones gratis incluido"],
        cta: "Contáctanos",
      },
    ],
  },
...
/** Builds FAQPage structured data matching the FAQ text actually rendered on a given page. */
export function buildFaqJsonLd(items: FaqItem[], pageUrl: string) {
  return {
    "@type": "FAQPage",
    "@id": `${pageUrl}#faq`,
