  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        />
        <div className="absolute -right-24 top-1/3 h-[600px] w-[500px] rounded-full bg-accent-cyan/[0.09] blur-[120px] will-change-transform" style={{ transform: "translateZ(0)" }} />
        <div className="absolute -left-16 bottom-1/4 h-[500px] w-[500px] rounded-full bg-accent-blue/[0.09] blur-[100px] will-change-transform" style={{ transform: "translateZ(0)" }} />
      </div>
